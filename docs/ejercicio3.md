...
![jekyll]({{"/assets/img/img20.png" | absolute_url}})
...
![jekyll]({{"/assets/img/img21.png" | absolute_url}})
...
![jekyll]({{"/assets/img/img22.png" | absolute_url}})

Aquí podemos ver los 5 **posts**, que aparecerán en el sitio web

![jekyll]({{"/assets/img/img23.png" | absolute_url}})
...
![jekyll]({{"/assets/img/img24.png" | absolute_url}})
...
![jekyll]({{"/assets/img/img25.png" | absolute_url}})

Al final comprobamos que el sitio web se despliega correctamente en **jekyll** 

## Paso 4

![jekyll]({{"/assets/img/img26.png" | absolute_url}})
